...
<div class="main-content">
    ...
    if (isset($_GET['id']) && isset($_GET['admin_id'])) {
        ...
        $sql = "SELECT * FROM tbl_class WHERE gym_id = ? AND admin_id = ?";
        $stmt = $conn->prepare($sql);
        if ($stmt) {
    ...
    <div class="class-card">
        <img src="../admin/class_image/<?php echo htmlspecialchars($class_image); ?>" alt="<?php echo htmlspecialchars($class_name); ?>" class="img-fluid">
        <h5><?php echo htmlspecialchars($class_name); ?></h5>
        <p style="max-width: 100%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
            <?php echo htmlspecialchars($class_description); ?>
        </p>
    </div>
</div>
