...
<body>
    <div class="container verification-container">
        <div class="verification-box">
            ...
            <a href="resendcode.php" class="resend-link">Didn't Receive a code? Resend</a>
        </div>
    </div>
</body>
</html>
...
if (isset($_POST['verify'])) {
    ...
    $sql = "SELECT * FROM tbl_user WHERE verification_code = '$verification_code_input' AND verification_expires < NOW()";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        // Update the user as verified
        $update_sql = "UPDATE tbl_user SET email_verified = 1 WHERE verification_code = '$verification_code_input'";
