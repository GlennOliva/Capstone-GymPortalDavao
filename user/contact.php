...
<div class="main-content">
    ...
    <form method="POST" class="contact-form">
        <!-- First row: Name, Last Name, Contact -->
        <div class="row">
            <div class="col-md-4">
        ...
        <!-- Second row: Date of birth, Age, Sex -->
        <div class="row mt-3">
        <div class="col-md-4">
    <label for="dob">Date of Birth</label>
    <input type="date" class="form-control" id="dob" name="dob" value="<?php echo isset($dob) ? $dob : ''; ?>" required>
</div>

            <div class="col-md-4">
                <label for="age">Age</label>
                <input type="number" class="form-control" id="age" name="age" value="<?php echo $age;?>" placeholder="Age" required>
            </div>
            <div class="col-md-4">
                <label for="sex">Sex</label>
                <input type="text" class="form-control" id="sex" name="sex" placeholder="Sex" value="<?php echo $gender;?>" required>
            </div>
        </div>
    ...
    <select class="form-control" id="class" name="class" required>
        ...
        <?php
// Query to get class data from tbl_class
$sql = "SELECT id, class_name FROM tbl_class WHERE gym_id = $gym_id AND admin_id = '$admin_id'";
...
?>
    ...
    <select class="form-control" id="payment" name="payment" required>
        ...
        <option value="gym_cashier">Gym Cashier</option>
    </select>
</div>
...
if (isset($_POST['send_message'])) {
    ...
    $sql = "INSERT INTO tbl_membership (user_id, gym_id, admin_id, class_id, height , weight , bmi , payment, address) VALUES (?, ?, ?, ?, ?, ?, ?,?,?)";
    
    // Prepare the statement
    $stmt = $conn->prepare($sql);
    if ($stmt) {
        // Bind parameters
        $stmt->bind_param("iiiisssss", $user_id, $gym_id, $admin_id, $class, $height, $weight, $bmi, $payment, $address );
