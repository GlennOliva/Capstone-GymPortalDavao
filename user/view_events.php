...
<div class="main-content">
    ...
    if (isset($_GET['id']) && isset($_GET['admin_id'])) {
        ...
        $sql = "SELECT * FROM tbl_event WHERE gym_id = ? AND admin_id = ?";
        $stmt = $conn->prepare($sql);
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($class = $result->fetch_assoc()) {
                    $service_image = $class['event_image'];
                    $service_name = $class['event_name'];
        ...
        <div class="col-md-3 text-center">
            <div class="service-card">
                <img src="../admin/events_image/<?php echo $service_image;?>" alt="Cardio Machines" class="img-fluid">
