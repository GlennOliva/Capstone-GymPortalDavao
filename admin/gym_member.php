...
@media screen and (max-width: 480px) {
    ...
    WHERE 
        m.admin_id = '$admin_id' AND status = 'Accept'
";
    ...
    <a href="gym_progress.php?id=<?php echo $user_id; ?>" style="background-color: green  !important;" class="edit">User Progress</a>
    <a href="#" style="background-color: orange !important;" class="archive" 
    onclick="confirmArchive('<?php echo $id; ?>', '<?php echo $user_id; ?>')">Archive</a>
</td>


<script>
function confirmArchive(id, userId) {
    Swal.fire({
        title: 'Are you sure?',
        ...
        if (result.isConfirmed) {
            // Redirect to the archive process
            window.location.href = 'archive_process.php?id=' + id + '&user_id=' + userId;
        }
    });
}
</script>
