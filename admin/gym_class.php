...
@media screen and (max-width: 480px) {
	...
	<section id="content">
		...
		<main>
            ...
            <div class="gym-table-container">
                <!-- Insert Button -->
                <a href="add_class.php" class="insert-button">Insert Class</a>
    ...
    $sql = "SELECT * FROM tbl_class WHERE admin_id = '$admin_id'";
    ...
    ?>
                <tr>
                    ...
                    <td><img src="class_image/<?php echo $image;?>" style="width: 50px; height: auto;" alt=""></td>
                    <td class="action-buttons">
    <a href="edit_class.php?id=<?php echo $id; ?>" class="edit">Edit</a>
    <a href="delete_class.php?id=<?php echo $id; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this about?');">Delete</a>
</td>
