...
@media screen and (max-width: 480px) {
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
            <h1 class="title">Gym Management</h1>
            ...
            <div class="gym-table-container">
                <!-- Insert Button -->
                <a href="add_gym.php" class="insert-button">Insert Gym</a>
    ...
    $sql = "SELECT * FROM tbl_gym WHERE admin_id = '$admin_id'";
    ...
    ?>
                <tr>
                    ...
                    <td><?php echo $gym_contact; ?></td>
                    <td><?php echo $gym_address; ?></td>
                    <td><?php echo $payment_method; ?></td>
                    <td><?php echo $payment_no; ?></td>
                    <td><img src="gym_image/<?php echo $image;?>" style="width: 50px; height: auto;" alt=""></td>
                    <td class="action-buttons">
    <a href="edit_gym.php?id=<?php echo $id; ?>" class="edit">Edit</a>
    <a href="delete_gym.php?id=<?php echo $id; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this gym?');">Delete</a>
</td>
    ...
    <?php
            ...
            // If no records found
            echo "<tr><td colspan='8'>No gym data found</td></tr>";
        }
    } else {
