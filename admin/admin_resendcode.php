...
if (isset($_POST['resend'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $update_sql = "UPDATE tbl_admin SET verification_code = '$new_verification_code', verification_expires = '$verification_expires' WHERE email = '$email'";
            ...
            try {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'admin_verify.php'; // Redirect to admin_verify.php
                    }
                });
            </script>";
            } catch (Exception $e) {
