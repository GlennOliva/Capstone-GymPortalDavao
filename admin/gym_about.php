...
@media screen and (max-width: 480px) {
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
            <h1 class="title">About Management</h1>
            ...
            <div class="gym-table-container">
                <!-- Insert Button -->
                <a href="add_about.php" class="insert-button">Insert About</a>
    ...
    $sql = "SELECT * FROM tbl_about WHERE admin_id = '$admin_id'";
    ...
    if ($res == true) {
        ...
        if ($count > 0) {
            ...
            while ($row = mysqli_fetch_assoc($res)) {
                $id = $row['id'];
                $purpoose = $row['purpose'];
                $summary = $row['summary'];
                $image = $row['about_image'];
    ?>
                <tr>
                    <td><?php echo $sn++; ?></td>
                    <td><?php echo $purpoose; ?></td>
                    <td><?php echo $summary; ?></td>
                    <td><img src="about_image/<?php echo $image;?>" style="width: 50px; height: auto;" alt=""></td>
                    <td class="action-buttons">
    <a href="edit_about.php?id=<?php echo $id; ?>" class="edit">Edit</a>
    <a href="delete_about.php?id=<?php echo $id; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this about?');">Delete</a>
</td>
