...
@media screen and (max-width: 480px) {
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
            <h1 class="title">User Progress</h1>
            ...
            <div class="gym-table-container">
                ...
                <a href="add_progress.php?id=<?php echo $id; ?>" class="insert-button">Insert Progress</a>
    ...
    $sql = "SELECT * FROM tbl_userprogress WHERE admin_id = '$admin_id' AND user_id = '$id'";
