...
@media screen and (max-width: 480px) {
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
            <h1 class="title">Insert User Progress</h1>
            <ul class="breadcrumbs">
                <li><a href="#">Admin</a></li>
                <li class="divider">/</li>
                <li><a href="#" class="active">Insert User Progress</a></li>
            </ul>
    ...
    <div class="profile-gym">
        <!-- Image upload -->
              <!-- First row -->
              <div class="row">
            <input type="text" placeholder="Exercise" name="exercise" required>
        </div>
    ...
    <input type="date" name="created_at" placeholder="Repetition Date" required>
        ...
        <div class="buttons">
            ...
            <input type="submit" class="upload-btn" value="Add Progress" name="submit_inventory"> <!-- Changed button -->
        </div>
    </div>
</form>
...
if (isset($_POST['submit_inventory'])) {
    ...
    if ($res == true) {
        ...
        echo '<script>
                swal({
                    title: "Success",
                    text: "User Progress successfully added!",
                    icon: "success"
                }).then(function() {
       window.location = "gym_progress.php?id=' . $user_id . '";
        ...
        echo '<script>
                swal({
                    title: "Error",
                    text: "Failed to add user progress details.",
                    icon: "error"
                }).then(function() {
                    window.location = "add_progress.php";
                });
            </script>';
    }
}
