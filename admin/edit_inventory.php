...
@media screen and (max-width: 480px) {
	...
	<section id="content">
		...
		<main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">/</li>
                <li><a href="#" class="active">Edit Inventory</a></li>
            </ul>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="image-upload-container">
            <!-- Current class image -->
            <img src="inventory_image/<?php echo $image; ?>" alt="Current Class Image" class="gym-image">
            <!-- Upload label -->
        ...
        <!-- First row -->
        <div class="row">
            <input type="text" name="inventory_name" placeholder="Enter Class" value="<?php echo htmlspecialchars($inventory_name); ?>" required>
        </div>
...
if (isset($_POST['update_inventory'])) {
        ...
        if ($upload == false) {
            echo '<script>
                    swal({
                        ...
                        window.location = "edit_inventory.php?id=' . $id . '";
                    });
                </script>';
            die();
        }
    ...
    if ($res == true) {
        ...
        echo '<script>
                swal({
                    title: "Success",
                    text: "Inventory details successfully updated!",
                    icon: "success"
                }).then(function() {
        ...
        echo '<script>
                swal({
                    title: "Error",
                    text: "Inventory details failed to update.",
                    icon: "error"
                }).then(function() {
                    window.location = "edit_inventory.php?id=' . $id . '";
                });
