...
@media screen and (max-width: 480px) {
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
            <h1 class="title">Insert Events</h1>
            <ul class="breadcrumbs">
                <li><a href="#">Admin</a></li>
                <li class="divider">/</li>
                <li><a href="#" class="active">Insert Events</a></li>
            </ul>
...
<div class="profile-gym">
    <form  method="POST" enctype="multipart/form-data">
        ...
        <div class="image-upload-container">
            <span class="upload-label">Upload Events Image</span>
        ...
        <!-- Buttons -->
        <div class="buttons">
            <input type="submit" name="add_event" value="Upload" class="upload-btn">
        </div>
    </form>
</div>
...
if (isset($_POST['add_event'])) {
    ...
    // Insert query
    $sql = "INSERT INTO tbl_event (admin_id,gym_id, event_name, description, event_image)
            VALUES ('$admin_id','$gym_id', '$event_name', '$description', '$image_name')";
    ...
    if ($res == true) {
        ...
        echo '<script>
                swal({
                    title: "Success",
                    text: "Event details successfully added!",
                    icon: "success"
                }).then(function() {
        ...
        echo '<script>
                swal({
                    title: "Error",
                    text: "Event details failed to add.",
                    icon: "error"
                }).then(function() {
                    window.location = "add_events.php";
                });
