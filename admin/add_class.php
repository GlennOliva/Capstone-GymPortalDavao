...
@media screen and (max-width: 480px) {
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
            <h1 class="title">Insert Class</h1>
            <ul class="breadcrumbs">
                <li><a href="#">Admin</a></li>
                <li class="divider">/</li>
                <li><a href="#" class="active">Insert Class</a></li>
            </ul>
    ...
    <form  method="POST" enctype="multipart/form-data">
        ...
        <div class="image-upload-container">
            ...
            <div class="image-upload">
                <input type="file" name="class_image" id="class_image" required>
            </div>
        </div>
        ...
        <!-- First row -->
        <div class="row">
            <input type="text" name="class_name" placeholder="Enter Class" required>
        </div>
        <!-- Second row -->
        ...
        <!-- Buttons -->
        <div class="buttons">
            <input type="submit" name="add_class" value="Upload" class="upload-btn">
        </div>
    </form>
</div>
...
if (isset($_POST['add_class'])) {
    ...
    // Insert query
    $sql = "INSERT INTO tbl_class (admin_id,gym_id, class_name, description, class_image)
            VALUES ('$admin_id','$gym_id', '$class_name', '$description', '$image_name')";
    ...
    if ($res == true) {
        ...
        echo '<script>
                swal({
                    title: "Success",
                    text: "Class details successfully added!",
                    icon: "success"
                }).then(function() {
        ...
        echo '<script>
                swal({
                    title: "Error",
                    text: "Class details failed to add.",
                    icon: "error"
                }).then(function() {
                    window.location = "add_class.php";
                });
