...
@media screen and (max-width: 480px) {
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
            <h1 class="title">Insert Services</h1>
            <ul class="breadcrumbs">
                <li><a href="#">Admin</a></li>
                <li class="divider">/</li>
                <li><a href="#" class="active">Insert Services</a></li>
            </ul>
    ...
    <div class="profile-gym">
        ...
        <!-- Second row -->
        <input type="text" class="address" placeholder="Service Description" name="service_description" required>

        <!-- Buttons -->
        <div class="buttons">
            <input type="submit" class="upload-btn" value="Add Service" name="submit_service"> <!-- Changed button -->
        </div>
    </div>
</form>
...
if (isset($_POST['submit_service'])) {
    ...
    $sql = "INSERT INTO tbl_service (admin_id, gym_id, service_name, description, service_image)
            VALUES ('$admin_id', '$gym_id', '$service_name', '$service_description', '$image_name')";
    ...
    if ($res == true) {
        ...
        echo '<script>
                swal({
                    title: "Success",
                    text: "Service details successfully added!",
                    icon: "success"
                }).then(function() {
        ...
        echo '<script>
                swal({
                    title: "Error",
                    text: "Failed to add service details.",
                    icon: "error"
                }).then(function() {
