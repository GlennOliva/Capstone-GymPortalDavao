...
@media screen and (max-width: 480px) {
	...
	<section id="content">
		...
		<main>
            ...
            <div class="gym-table-container">
                <!-- Insert Button -->
                <a href="add_services.php" class="insert-button">Insert Services</a>
    ...
    $sql = "SELECT * FROM tbl_service WHERE admin_id = '$admin_id'";
    ...
    ?>
                <tr>
                    <td><?php echo $sn++; ?></td>
                    <td><img src="services_image/<?php echo $image;?>" style="width: 50px; height: auto;" alt=""></td>
                    <td><?php echo $service_name; ?></td>
                    <td><?php echo $description; ?></td>
             
                    <td class="action-buttons">
    <a href="edit_services.php?id=<?php echo $id; ?>" class="edit">Edit</a>
    <a href="delete_services.php?id=<?php echo $id; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this services?');">Delete</a>
</td>
